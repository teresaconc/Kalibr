    ...
    for obs in obslist: 
        ...
        for i in range(0, target.size()):
            ...
            if valid and success:
                #print T_cam_w * p_target
               
                #print success
                #print "ptarget"
                #print i
                #print p_target.toHomogeneous()

                #print target.point(i)
                #print (T_cam_w*p_target).toHomogeneous()
