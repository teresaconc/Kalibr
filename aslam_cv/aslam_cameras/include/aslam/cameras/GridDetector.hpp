...
class GridDetector {
 public:
  ...
  bool findTarget(const cv::Mat &image, const aslam::Time &stamp,
                  GridCalibrationTargetObservation & outObservation,bool depth=false) const;

  bool findTarget(const cv::Mat &image, GridCalibrationTargetObservation &outObservation,bool depth=false) const;
